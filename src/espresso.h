...
/* cvrout.c */ extern void fpr_header (FILE *fp, pPLA PLA, int output_type , FILE *newfilefp);
/* cvrout.c */ extern void fprint_pla (FILE *fp, pPLA PLA, int output_type , char newfilename[]);
...
/* cvrout.c */ extern void print_cube (register FILE *fp, register pset c, register char *out_map ,FILE *newfilefp);
